...
# 2) append to the history file, don't overwrite it
# 3) for setting history length see HISTSIZE and HISTFILESIZE in bash(1)
...
if [ -f ~/config/.bash_prompt ]; then
    ...
    ##PS1='${debian_chroot:+($debian_chroot)}\[\033[33m\]\u\[\033[01;34m\]\w\[\033[00m\]\$ '
#else
